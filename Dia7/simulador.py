...
# En base a los cursos y alumnos generados, crear el simulador dentro de esta funcion para que enlace los alumnos con los cursos,
#  no se puede repetir un alumno-curso
    # 2   -  2
    # 2   -  2
